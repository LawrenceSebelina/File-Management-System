        ...
        <nav class="sidenavbar-content">
            <div> 
                ...
                <div class="sidenavbar-menus">
                    <a href="adminEntry.php" class="sidenavbar-menu" title="Departments"> <i class="fa-solid fa-building-user nav-icon"></i> <span class="sidenavbar-menu-title">Department</span> </a> 
                    ...
                    <a href="#" class="sidenavbar-menu active" title="Subjects"> <i class="fa-solid fa-book fa-xl nav-icon" style="margin-left: 0.1rem;"></i> <span class="sidenavbar-menu-title">Subject</span> </a>
                </div>
            </div>   
                <?php 
    ...
    <div class="main-content">
        ...
        <div class="card mb-3">
            ...
            <div class="d-flex justify-content-end mb-5">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#adminAddSubjectModal"><i class="fa-solid fa-square-plus"></i>&nbsp&nbsp<strong>Add Subject</strong></button>
            </div> 
                ...
                <table id="example" class="table table-striped display" style="width:100%">
                    ...
                    <tbody>
                        <?php
                            $query = mysqli_query($conn,"SELECT * FROM subject ORDER BY subject_id DESC") or die(mysqli_error());
                        ...
                        <tr class="odd gradeX">  
                            ...
                            <td class="text-center" width="100">
                                <a title="Edit Subject" role="button" class="adminEditSubject btn btn-info"><i class="fa-solid fa-pen-to-square fa-lg"></i></a>
                                <a title="Delete Subject" role="button" class="adminDeleteSubject btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
