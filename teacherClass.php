        ...
        <nav class="sidenavbar-content">
            <div> 
                ...
                <div class="sidenavbar-menus">
                    ...
                    <a href="#" class="sidenavbar-menu active" title="Class"> <i class="fa-solid fa-users-rectangle nav-icon"></i> <span class="sidenavbar-menu-title">Class</span> </a>
    ...
    <div class="main-content">
        ...
        <div class="card mb-3">
            ...
            <div class="d-flex justify-content-end mb-5">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addClassModal"><i class="fa-solid fa-square-plus"></i>&nbsp&nbsp<strong>Add Class</strong></button>
            </div>   
                ...
                <table id="example" class="table table-striped display" style="width:100%">
                    ...
                    <tbody>
                        <?php
                            $query = mysqli_query($conn,"SELECT * FROM class WHERE teacher_id = '$session_id' ORDER BY class_id DESC") or die(mysqli_error());
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td style="display:none;"><?php echo $row['class_id']; ?></td> 
                                <td><a class="view-class btn btn-info" title="View Class" id="<?php echo $class_id; ?>" href="teacherClassInfo.php<?php echo '?id='.$class_id; ?>"><i class="fa-solid fa-book-open"></i>&nbsp<strong><?php echo $row['course_id']; ?></strong></a></td>
                                <td><?php echo $row['subject_id']; ?></td> 

                                <td class="text-center" width="50">
                                    <a class="deleteClass btn btn-danger" title="Delete Class" role="button"><i class="fa-solid fa-trash-can"></i></a>          
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
