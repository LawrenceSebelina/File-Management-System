                ...
                <table id="example" class="table table-striped display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td><a title="View Class" class="view-class btn btn-info" id="<?php echo $class_id; ?>"  href="studentClassInfo.php<?php echo '?id=' . $class_id; ?>"><i class="fa-solid fa-book-open"></i>&nbsp<strong><?php echo $row['subject_id']; ?></strong></a></td> 
