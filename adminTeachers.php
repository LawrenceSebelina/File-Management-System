...
<body class="body" id="body">
        ...
        <nav class="sidenavbar-content">
            <div> 
                ...
                <div class="sidenavbar-menus">
                    ...
                    <a href="#" class="sidenavbar-menu active" title="Teachers"> <i class="fa-solid fa-user-tie fa-xl nav-icon" style="margin-left: 0.1rem;"></i> <span class="sidenavbar-menu-title">Teachers</span> </a>
    ...
    <div class="main-content">
        ...
        <div class="alert alert-success d-flex align-items-center mt-3" role="alert">
            <i class="fa-solid fa-user-tie fa-2xl me-2"></i>
            <div>
        ...
        <div class="card mb-3">
            ...
            <div class="d-flex justify-content-end mb-5">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#adminAddTeacherModal"><i class="fa-solid fa-square-plus"></i>&nbsp&nbsp<strong>Add Teacher</strong></button>
            </div> 
                ...
                <table id="example" class="table table-striped display" style="width:100%">
                    ...
                    <tbody>
                        <?php
                            $query = mysqli_query($conn,"SELECT * FROM teacher ORDER BY teacher_id DESC") or die(mysqli_error());
                        ...
                        <tr class="odd gradeX">  
                            ...
                            <td class="text-center" width="100">
                                <a title="Edit Teacher" role="button" class="adminEditTeacher btn btn-info"><i class="fa-solid fa-pen-to-square fa-lg"></i></a>
                                <a title="Delete Teacher" role="button" class="adminDeleteTeacher btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
