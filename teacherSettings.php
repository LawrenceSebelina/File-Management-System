        ...
        <div class="card mb-3">
            <div class="card-body bg-success bg-opacity-10">
                <form class="row g-3" action="mainFunctions.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="tacherSettingsPassword" value="<?php echo $user_row['password']; ?>">
                    <input type="hidden" name="teacherEditSettingsId" value="<?php echo $session_id; ?>">
                    <input type="hidden" name="user-photo" value="<?php echo $user_row['location']; ?>">

                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary me-2" name="teacherSettings"><i class="fa-solid fa-arrow-up-from-bracket"></i>&nbsp<strong>&nbsp&nbsp&nbspSave&nbsp&nbsp&nbsp</strong></button>
