        ...
        <nav class="sidenavbar-content">
            <div> 
                ...
                <div class="sidenavbar-menus">
                    ...
                    <a href="#.php" class="sidenavbar-menu active" title="Courses"> <i class="fa-solid fa-users-rectangle nav-icon"></i> <span class="sidenavbar-menu-title">Courses</span> </a>
    ...
    <div class="main-content">
        ...
        <div class="card mb-3">
            ...
            <div class="d-flex justify-content-end mb-5">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#adminAddCourseModal"><i class="fa-solid fa-square-plus"></i>&nbsp&nbsp<strong>Add Course</strong></button>
            </div> 
                ...
                <table id="example" class="table table-striped display" style="width:100%">
                    ...
                    <tbody>
                        <?php
                            $query = mysqli_query($conn,"SELECT * FROM course ORDER BY course_id DESC") or die(mysqli_error());
                        ...
                        <tr class="odd gradeX">  
                            ...
                            <td class="text-center" width="100">
                                <a title="Edit Course" role="button" class="adminEditCourse btn btn-info"><i class="fa-solid fa-pen-to-square fa-lg"></i></a>
                                <a title="Delete Course" role="button" class="adminDeleteCourse btn btn-danger"><i class="fa-solid fa-trash-can"></i></a 
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
