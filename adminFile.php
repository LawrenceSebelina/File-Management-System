...
<body class="body" id="body">
        ...
        <nav class="sidenavbar-content">
            <div> 
                ...
                <div class="sidenavbar-menus">
                    ...
                    <a href="#" class="sidenavbar-menu active" title="Files"> <i class="fa-solid fa-folder-open nav-icon"></i> <span class="sidenavbar-menu-title">Files</span> </a>
    ...
    <div class="main-content">
        ...
        <div class="alert alert-success d-flex align-items-center mt-3" role="alert">
            <i class="fa-solid fa-file fa-2xl me-2"></i>
            <div>
                    ...
                    <tbody>
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <td style="display:none;"><?php echo $row['file_id']; ?></td> 
                                ...
                                <td class="text-center" width="50">
                                    <a class="deleteMaterial btn btn-danger" title="Delete Material" role="button"><i class="fa-solid fa-trash-can"></i></a>            
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
