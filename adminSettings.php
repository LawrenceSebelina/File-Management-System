        ...
        <nav class="sidenavbar-content">
            <div> 
                ...
                <div class="sidenavbar-menus">
                    ...
                    <a href="#" class="sidenavbar-menu active" title="Settings"> <i class="fa-solid fa-gear fa-xl nav-icon"></i> <span class="sidenavbar-menu-title">Departments</span> </a>
                    <a href="adminLogs.php" class="sidenavbar-menu" title="My Activity"> <i class="fa-solid fa-clock-rotate-left fa-xl nav-icon"></i> <span class="sidenavbar-menu-title">My Activity</span> </a>
                </div>
            </div>   
                ...
                <form class="row g-3" action="mainFunctions.php" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="upload-photo" class="fw-bold ms-3 text-success">Upload Photo</label>
                        <div class="preview-photo">
                            <div class="preview">
                                <img src="<?php echo $user_row['location']; ?>" id="photo-previewer8">
                                <input type="file" id="file-preview8" accept="image/*" name="image" onchange="previewImage8(event);">
                                <label for="file-preview8"><i class="fa-solid fa-image"></i> Choose Image</label>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="input-group d-flex justify-content-center">
                        ...
                        <div class="col-sm-3 me-4">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="middleName" id="floatingMiddleName" value="<?php echo $user_row['middlename']; ?>">
                    ...
                    <input type="hidden" name="adminSettingsPassword" value="<?php echo $user_row['password']; ?>">
                    <input type="hidden" name="adminEditSettingsId" value="<?php echo $session_id; ?>">
                    <input type="hidden" name="user-photo" value="<?php echo $user_row['location']; ?>">

                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary me-2" name="adminSettings"><i class="fa-solid fa-arrow-up-from-bracket"></i>&nbsp<strong>&nbsp&nbsp&nbspSave&nbsp&nbsp&nbsp</strong></button>
                        <button type="reset" class="btn btn-danger"><i class="fa-solid fa-ban"></i>&nbsp<strong>&nbspCancel&nbsp</strong></button>
                    </div>
                </form>
            </div>
        </div>
